...
class Application:
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("Gesture language to text converter")
        self.root.protocol('WM_DELETE_WINDOW', self.destructor)
        self.root.geometry("1100x600")
        self.panel = tk.Label(self.root)
        self.panel.place(x = 85, y = 10, width = 950, height = 415)
        self.panel2 = tk.Label(self.root) # initialize image panel
        self.panel2.place(x = 575, y = 75, width = 295, height = 295)
        
        self.T = tk.Label(self.root)
        self.T.place(x=10,y = 5)
        self.T.config(text = "Gesture to Text",font=("courier",25,"bold"))
        self.panel3 = tk.Label(self.root) # Current SYmbol
        self.panel3.place(x = 455,y=445)
        self.T1 = tk.Label(self.root)
        self.T1.place(x = 5,y = 445)
        self.T1.config(text="Character :",font=("Courier",18,"bold"))
        self.panel4 = tk.Label(self.root) # Word
        self.panel4.place(x = 200,y=465)
        self.T2 = tk.Label(self.root)
        self.T2.place(x = 10,y = 485)
        self.T2.config(text ="Word :",font=("Courier",18,"bold"))
        self.panel5 = tk.Label(self.root) # Sentence
        self.panel5.place(x = 350,y=505)
        self.T3 = tk.Label(self.root)
        self.T3.place(x = 10,y = 525)
        self.T3.config(text ="Sentence :",font=("Courier",18,"bold"))

        self.T4 = tk.Label(self.root)
        self.T4.place(x = 235,y = 560)
        self.T4.config(text = "Suggestions",fg="Blue",font = ("Courier",18,"bold"))
